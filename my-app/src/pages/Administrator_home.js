...
import Navbar from "../component/Navbar";
  ...
  export default function Administrator_home() {
    ...
    const callouts = [
        {
          name: 'Total Room Number',
          description: stats.totalRoomNumber + ' Rooms',
    
        },
        {
          name: 'All Time Total Amount',
          description: 'Rp. ' + stats.totalAmount,
    
    
        },
        {
          name: 'All Time Total Canceled',
          description: stats.totalCanceled ,
    
    
        },
        {
            name: 'Total Room Sold This Week',
            description: stats.totalRoomNumberThisWeek + " Rooms",
    
          },
          {
            name: 'Total Revenue This Week',
            description: 'Rp. ' + stats.totalAmountThisWeek,
    
          },
          {
            name: 'Total Canceled This Week',
            description: stats.totalCanceledThisWeek,
    
          },
          {
            name: 'Total Confirmed ',
            description: stats.totalConfirmed,
    
          },
          {
            name: 'Total Confirmed This Week',
            description: stats.totalConfirmedThisWeek,
    
          },
          {
            name: 'Orders not confirmed',
            description: stats.totalNotConfirmed,
    
          },
          {
            name: 'Total product listed',
            description: stats.totalProductListed
          },
          {
            name:"Total product viewed",
            description: stats.totalProductViewed
          },
          {
            name: 'Total account registered',
            description: stats.totalAccountRegistered
          }
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="mx-auto max-w-2xl py-8 sm:py-24 lg:max-w-none lg:py-8">
            ...
            <div className="mt-4 h-[50px] font-poppins flex space-x-4">
                  <button 
                    className="bg-cyan-300 text-black px-4 py-2 rounded"
